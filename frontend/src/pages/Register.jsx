  ...
  return (
    <section className="auth-section">
      <div className="auth-panel auth-panel-wide">
        ...
        <p className="form-intro">Register to manage support requests for your KIT Robotics systems.</p>

        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          {errors.root?.server && <div className="form-alert" role="alert">{errors.root.server.message}</div>}
          <label className="field">
            <span>Full name</span>
            <input autoComplete="name" {...register('name', { required: 'Name is required', maxLength: 255 })} />
