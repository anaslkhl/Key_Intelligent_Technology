...
export const DocumentLibrary = lazy(() => import('./documents/DocumentLibrary'))
export const DocumentDetail = lazy(() => import('./documents/DocumentDetail'))
export const MyProductDocuments = lazy(() => import('./documents/MyProductDocuments'))
