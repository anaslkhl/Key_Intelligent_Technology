...
export default function Footer() {
  return (
    <footer className="bg-slate-900 px-3 pb-8 pt-16 text-slate-300 sm:px-4">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-14 border-t border-slate-700 pt-7 text-sm text-slate-400">
          © 2026 KIT Robotics. All rights reserved.
        </div>
      </div>
    </footer>
  );
