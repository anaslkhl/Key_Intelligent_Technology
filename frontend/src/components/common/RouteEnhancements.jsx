...
const titles = [
  ...
  [/^\/admin\/dashboard$/, 'Admin dashboard'], [/^\/admin\/users$/, 'User management'], [/^\/admin\/reviews$/, 'Review moderation'], [/^\/admin\/features$/, 'Feature roadmap'], [/^\/admin\/analytics\/knowledge-base$/, 'Knowledge-base analytics'], [/^\/admin\/analytics$/, 'Support analytics'], [/^\/admin\/export$/, 'Export data'],
